...
export const MODEL_CONFIGURATION_STORAGE_KEY = "safetyiq.model-configuration";
...
export const DEFAULT_MODEL_CONFIGURATION: ModelConfigurationPersisted = {
  ...
  apiToken: "",
  preferredWatchModelKey: "lfm-ucf",
  frameAnalysisModelKey: "lfm-ucf",
  summaryChatModelKey: "liquid/lfm2.5-1.2b",
